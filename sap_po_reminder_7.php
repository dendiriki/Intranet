...
$sql = " select a.ebeln,
     ...
     where a.mandt = b.mandt
       ...
       and e.wemng <= 0
       and e.etenr = '0001'
       and to_date(e.eindt, 'YYYYMMDD') - TRUNC(sysdate) = 7
       and b.elikz = ' '
       and a.frgke in ('G','R')
...
if(!empty($data1)){
	...
	$email_msg1 .= "Please see the delivery date for the below mentioned orders are getting due within 7 days.<br><br>";
	...
	$email_msg1 .= "</table><br>";
        ...
        $mail->sendTheMailPU("PO Delivery Reminder I", $email_msg, $recipient);
