...
//section 1
$today = date("Ymd");
$sql = "SELECT bukrs, sfunc, regul, sdesc, artcl, prfmr, preml, revwr, rveml, duedt FROM SAPSR3.ZFI_AUD_MD_01@DBSAP_IIP where cmpst = ' ' and cmpdt = '00000000' AND  ( rmdt1 = '$today' OR rmdt2 = '$today' )";
...
//section 2
$sql = "SELECT bukrs, sfunc, sdesc, certy, isudt, prfmr, preml, revwr, rveml, duedt FROM SAPSR3.ZFI_AUD_MD_02@DBSAP_IIP where cmpst = ' ' and cmpdt = '00000000' AND  ( rmdt1 = '$today' OR rmdt2 = '$today' )";
...
//Section 3
$today = date("Ymd");
$sql = "SELECT bukrs, sfunc, sdesc, certy, agrdt, prfmr, preml, revwr, rveml, agrrd FROM SAPSR3.ZFI_AUD_MD_03@DBSAP_IIP where cmpst = ' ' and cmpdt = '00000000' AND  ( rmdt1 = '$today' OR rmdt2 = '$today' )";
