...
$date1 = date("Ymd", strtotime(date("Y-m-d") . " -1 day")) . "230000";
$date2 = date("Ymd") . "065959";
...
if (!empty($data)) {
    ...
    $email_msg .= "<p>No EAF Data 23:00 to 07:00</p>";
}

//select data LRF

$sql = "select * from sapsr3.ZPP_SMS_LRF_DATA@dbsap_iip "
        . "where concat(erdat,erzet) between '" . $date1 . "' and '" . $date2 . "' order by erdat asc, TO_NUMBER(srlno) asc";
...
if (!empty($data)) {
    ...
    $email_msg .= "<p>No LRF Data 23:00 to 07:00</p>";
}
...
if (!empty($data)) {
    ...
    $email_msg .= "<p>No CCM Data 23:00 to 07:00</p>";
}
...
$mail->sendTheMailAdv("SMS Data 23:00 to 07:00", $email_msg, $recipient);

$myfile = fopen("reminder_eaf_1.txt", "w") or die("Unable to open file!");
