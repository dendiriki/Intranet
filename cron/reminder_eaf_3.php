...
//$date1 = date("Ymd") . "150000";
//$date2 = date("Ymd") . "225959";
$date1 = date("Ymd", strtotime(date("Y-m-d") . " -1 day")) . "150000";
$date2 = date("Ymd", strtotime(date("Y-m-d") . " -1 day")) . "225959";
...
if (!empty($data)) {
    ...
    $email_msg = "<p>No EAF Data 15:00 to 23:00</p>";
}
...
if (!empty($data)) {
    ...
    $email_msg .= "<p>No LRF Data 15:00 to 23:00</p>";
}
...
if (!empty($data)) {
    ...
    $email_msg .= "<p>No CCM Data 15:00 to 23:00</p>";
}
...
$mail->sendTheMailAdv("SMS Data 15:00 to 23:00", $email_msg, $recipient);

$myfile = fopen("reminder_eaf_3.txt", "w") or die("Unable to open file!");
