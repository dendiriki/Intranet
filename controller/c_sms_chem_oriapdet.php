...
if ($action == "sms_chem_oriapdet") {
    set_time_limit(0);
    define("PDO_ISPAT3", "oci:dbname=(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 10.1.0.25)(PORT = 1521))(CONNECT_DATA = (SID = smsprd)))");
    $type = 'EAF';
    if (isset($_REQUEST["type"])) {
        $type = $_REQUEST["type"];
    }
    $conn = new PDO(PDO_ISPAT3, "production", "production");
...
if ($action == "ajax_sms_chem_oriapdet") {
    set_time_limit(0);
    define("PDO_ISPAT3", "oci:dbname=(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 10.1.0.25)(PORT = 1521))(CONNECT_DATA = (SID = smsprd)))");
    $type = 'EAF';
    if (isset($_REQUEST["type"])) {
